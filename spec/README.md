...
| -------- | ------------------------------------- | ------------------------- |
| 0.4.0    | Public draft — current                | [`v0.4.0.md`](v0.4.0.md)  |
| 0.3.0    | Superseded                            | [`v0.3.0.md`](v0.3.0.md)  |
...
- **0.4.0** adds optional absolute-luminance fields (`stimuli[].luminanceCdM2`, `calibration.setup.screen.maxLuminanceCdM2`, `calibration.setup.screen.backgroundLuminanceCdM2`) and presentation-timing fields (`test.stimulusDurationMs`, `test.interStimulusIntervalMs`, `test.interStimulusIntervalJitterMs`) so `sensitivityDb` and response-time measurements are portable across devices. Purely additive; see `spec/v0.4.0.md` §10.
